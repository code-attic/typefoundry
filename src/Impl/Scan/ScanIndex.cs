...
{    
    public class ScanIndex
    {
        ...
        public List<Type> AssemblyInitializers { get; set; }
        ...
        public void PopulateAssemblyList()
        {
            var dependencies = ImplementorsOfType.TryGet( typeof( IDefineDependnecies ) );
            var scanners = ImplementorsOfType.TryGet( typeof( typefoundry.IDefineScan ) );
            ...
            AssemblyInitializers = initializers.Item1
